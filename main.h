...
/**
 * dis section for size2
 */
#define S_SHORT 1
#define S_LONG 2

/**
 * struct fmt - Struct fmt3
 *
 * @fmt: is a format
...
/**
 * struct fmt fmt_t - Struct ftm ftm_t4
 * @fmt: a format.
 * @fm_t: function.
 */
...
/**
 *  dis section for Funtions to print5
 * chars and strings
 */
...
/**
 * this section for function print10
 * reverse strings
 */
...
int width, int precision, int length, char padd,
char extra_c);
int write_unsgnd(int is_negative, int ind,
char buffer[], int flags, int width, int
precision, int size);

/**
 * section fore utils function13
 */
int is_digit(char);
